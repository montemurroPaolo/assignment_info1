...
| 1.6 | Multiple errors | `log0` typo, wrong first expr | 0/2 |
...
```r
# Student wrote:
(log10(1) + log0(2))/ ((pi+1)/(pi-1))  # log0 doesn't exist!
...
| 2.9 | Missing comma | Syntax error | 0/2 |
...
| 3.3 | `mean(k==4 \| k==5)` | Logic correct if k was right | 1/2 |
| 3.4 | `z= 2*K - m` | Uses K instead of k (case!) | 1/3 |
