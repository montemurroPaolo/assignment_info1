...
**Submission:** https://github.com/montemurroPaolo/assignment_info1/blob/main/submissions/Anna_Bonera.R
...
| 1.8 | "case sensitive" | Missing `#` comment format (plain text, not R comment) | 0/1 |
